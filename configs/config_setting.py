...
class setting_config:
    ...
    raft_args = {
        ...
        "restore_ckpt": None,
        "coarse_config": None
        # Number of iterations for RAFT inference
        # You can add more RAFT-specific settings here
    }
    raft_checkpoint = "./pretrain/Tartan-C-T-TSKH-spring540x960-M.pth"  # Path to the pre-trained RAFT model checkpoint
